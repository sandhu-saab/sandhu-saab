...
CODE = (environ.get('CODE', 'https://envs.sh/aPL.jpg'))
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002487267521').split()]  # Channel id for auto indexing (make sure bot is admin)
...
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('AUTH_CHANNEL', '-1002429510787 -1002116325676').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://sandhusaab61291:Sandhu@cluster0.c67tt.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
